    ...
    <div class="card">
        <div>
            ...
            <p>After finishing my university studies, I started looking at Laravel as well as vanilla PHP as to
                ...
                current and five-day forecast. Using Tailwind I was able to create an attractive and clear
                dashboard
            ...
            <p>I’ve also worked on projects involving authentication systems and closely followed the MVC
                architectural pattern. One such project is a plant application that organises plants into
                various
                categories. Each category contains different plant types, allowing users to sort and filter
                plants
